...
public class GameManager : MonoBehaviour {
	...
	public int beatExploreLevelScore = 0;
		...
		if (canBeatLevel) {
			...
			switch (GameSettings.difficulty) {
				case GameSettings.gameDifficulties.Hard:
					...
					GameObject.FindGameObjectWithTag("ExploreModeCanvas").SetActive(false);
				...
				case GameSettings.gameDifficulties.Normal:
					...
					break;
				case GameSettings.gameDifficulties.Explore:
					GameObject.FindGameObjectWithTag("EasyModeCanvas").SetActive(false);
					GameObject.FindGameObjectWithTag("NormalModeCanvas").SetActive(false);
					GameObject.FindGameObjectWithTag("HardModeCanvas").SetActive(false);
					GameObject.FindGameObjectWithTag("ExploreModeCanvas").SetActive(true);
					beatLevelScore = beatExploreLevelScore;
					break;
				// Easy is the default
				default:
